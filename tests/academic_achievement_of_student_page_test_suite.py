...
class AddAcademicAchievementStudent(BaseTest):
    ...
    def test_update_academic_achievement_successfull(self):
        self.go_to_page()
        my_url = "http://172.24.28.21:3000/#!/logros-academicos/56392245bf6ad92638c8a0d6//563b8023bf6ad92638c8a1d0/edit"
        self.driver.get(my_url)
        create_academic_achievement_page = AcademicAchievementPage(self.driver)
        update_academic_achievement_page = ShowAcademicAchievementPage(self.driver)
        create_academic_achievement_page.enter_name("Premio1")
        create_academic_achievement_page.enter_description("Juegos1")
        create_academic_achievement_page.enter_award("Medalla1")
        update_academic_achievement_page.click_update_academic_achievement_button()
        viewStudentPage = ViewStudentPage(self.driver)
        viewStudentPage.is_add_responsible_button_displayed()

    def test_update_academic_achievement_empty_fields(self):
        self.go_to_page()
        my_url = "http://172.24.28.21:3000/#!/logros-academicos/56392245bf6ad92638c8a0d6//563b8023bf6ad92638c8a1d0/edit"
        self.driver.get(my_url)
        create_academic_achievement_page = AcademicAchievementPage(self.driver)
        update_academic_achievement_page = ShowAcademicAchievementPage(self.driver)
        create_academic_achievement_page.enter_name("")
        create_academic_achievement_page.enter_description("Juegos1")
        create_academic_achievement_page.enter_award("Medalla1")
        update_academic_achievement_page.click_update_academic_achievement_button()
        update_academic_achievement_page.is_name_academic_award_displayed()

    def test_update_academic_achievement_all_empty_fields(self):
        self.go_to_page()
        my_url = "http://172.24.28.21:3000/#!/logros-academicos/56392245bf6ad92638c8a0d6//563b8023bf6ad92638c8a1d0/edit"
        self.driver.get(my_url)
        create_academic_achievement_page = AcademicAchievementPage(self.driver)
        update_academic_achievement_page = ShowAcademicAchievementPage(self.driver)
        create_academic_achievement_page.enter_name("")
        create_academic_achievement_page.enter_description("")
        create_academic_achievement_page.enter_award("")
        update_academic_achievement_page.click_update_academic_achievement_button()
        update_academic_achievement_page.is_name_academic_award_displayed()
